	...
	public function read($input){
		...
		while(true){
			...
			if ("storeInfo" == $schemeField){
				...
				$this->storeInfo = new \Luohonen\LaravelUnionSdk\Vip\Request\StoreInfo();
			...
			if ("commentsInfo" == $schemeField){
				...
				$this->commentsInfo = new \Luohonen\LaravelUnionSdk\Vip\Request\GoodsCommentsInfo();
			...
			if ("storeServiceCapability" == $schemeField){
				...
				$this->storeServiceCapability = new \Luohonen\LaravelUnionSdk\Vip\Request\StoreServiceCapability();
			...
			if($needSkip){
				...
				\Luohonen\LaravelUnionSdk\Vip\Osp\Protocol\ProtocolUtil::skip($input);
			}
