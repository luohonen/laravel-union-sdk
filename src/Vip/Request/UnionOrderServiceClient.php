...
class UnionOrderServiceClient{
	...
	private static function regis(){
		...
		$path =  \Luohonen\LaravelUnionSdk\Vip\Osp\Util\PathUtil::getRootPath ();
		$nsLoader = new \Luohonen\LaravelUnionSdk\Vip\Osp\ClassLoader\ClassLoader ();
	...
	public static function getService(){
		...
		$ctx =  \Luohonen\LaravelUnionSdk\Vip\Osp\Context\InvocationContextFactory::getInstance ();
		...
		return new \Luohonen\LaravelUnionSdk\Vip\Request\UnionOrderServiceHelper();
	}
