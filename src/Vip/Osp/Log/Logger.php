...
namespace Luohonen\LaravelUnionSdk\Vip\Osp\Log;
...
class Logger {
	...
	private static function init(){
		Logger::$LOG_PATH =  \Luohonen\LaravelUnionSdk\Vip\Osp\Util\PathUtil::getRootPath()."/osp-log/";
	...
	public static function error($msg, $e) {
		...
		if(Logger::$LOG_LEVEL <= Logger::$LOG_LEVEL_ERROR){
			if ($e instanceof \Luohonen\LaravelUnionSdk\Vip\Osp\Exception\OspException){
