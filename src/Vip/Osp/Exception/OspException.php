...
namespace Luohonen\LaravelUnionSdk\Vip\Osp\Exception;
...
// 	}
	...
	public function __construct($returnMessage, $returnCode=\Luohonen\LaravelUnionSdk\Vip\Osp\Exception\OspException::CALLEE_UNKNOWN_EXCEPTION) {
		$this->returnCode = $returnCode;
		$this->returnMessage = $returnMessage;
	}
